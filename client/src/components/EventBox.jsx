...
const Eventbox = ({isLatestEvent, title, date, venue}) => {
  return (
    <div className="mx-[5%]">
        {isLatestEvent ? (
            <div className="w-[600px] h-[280px] bg-orange-500 text-white flex mb-[5%] mx-[20%] py-[5%] px-[5%] gap-6 rounded-xl hover:scale-110 transition-all cursor-pointer">
                <div className="mb-8">
                    <p className="font-bold tracking-wider">NEXT EVENT</p>
                </div>
                <div className="text-center mt-[8%] flex flex-col gap-4 tracking-wider">
